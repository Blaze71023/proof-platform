    ...
    >
      ...
      >
        ...
        <div style={{ padding: 18, display: "grid", gap: 14, position: "relative", zIndex: 1 }}>
          <ActionRow />
          <Panel title="Team Assignment Board">
            <EmptyState />
          </Panel>
        </div>
      </div>
    ...
    >
      ...
      <div>
        ...
        <div style={{ fontSize: 13, color: THEME.textMuted, lineHeight: 1.5 }}>
          Team workload, assignments, and service visibility across the shop floor.
        </div>
      </div>
    ...
    <div style={{ display: "grid", gridTemplateColumns: "1fr auto", gap: 12 }}>
      ...
      >
        ...
        <span style={{ fontSize: 13, color: THEME.textMuted }}>
          Search technicians, roles, or assigned vehicles...
        </span>
      </div>
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 420, display: "grid", justifyItems: "center" }}>
        ...
        >
          <Users size={30} strokeWidth={2.1} color={THEME.emerald} />
        </div>
        ...
        <div style={{ fontSize: 14, color: THEME.textMuted, lineHeight: 1.65, marginBottom: 18 }}>
          Once jobs are created and assigned, your team board and workload visibility will appear here.
        </div>
