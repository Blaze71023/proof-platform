...
const VEHICLES: VehicleCardData[] = [
  ...
  },
  {
    ...
    make: "Toyota",
    model: "Camry",
    vin: "4TBE4CKS0JU123456",
    status: "Waiting on Parts",
    accent: "blue",
    img: "/images/fleetproof-equipment.jpg",
  },
  {
    id: "3",
    year: "2015",
...
const APPROVALS: ApprovalCardData[] = [
  {
    ...
    concern: "Brake Pads & Rotors",
    estimate: "$475.00",
    status: "Pending Approval",
    accent: "orange",
    img: "/images/driveproof-inspection.png",
  },
  {
    id: "2",
...
const ACTIVE_REPAIRS: RepairCardData[] = [
  {
    id: "1",
    title: "Engine Repair",
    vehicle: "Ford F-150",
...
const TECHS: TechCardData[] = [
  {
    id: "1",
    name: "John D.",
    role: "Engine Repair",
    vehicle: "Ford F-150",
    avatar: "/images/proof-hero.png",
  },
  {
    id: "2",
    name: "Mark T.",
    role: "Diagnostics",
    vehicle: "BMW X5",
    avatar: "/images/proof-platform.png",
  },
  {
    id: "3",
    name: "Sarah L.",
    role: "Suspension",
    vehicle: "Toyota Camry",
    avatar: "/images/equipment-proof.jpg",
  },
];
...
const ALERTS: AlertItem[] = [
  {
    id: "1",
    text: "Audi A6 - Warning Lights On - Needs Diagnostic",
    tone: "warning",
  },
  {
    id: "2",
    text: "Chevy Silverado - Coolant Leak - Urgent Repair",
    tone: "danger",
  },
  {
    id: "3",
    text: "Subaru Outback - Check Engine Light - High Priority",
    tone: "danger",
  },
];
...
function TopBar({ isMobile }: { isMobile: boolean }) {
  return (
    ...
    >
      ...
      >
        <TopMetric value="8" label="Vehicles in Shop" />
        <TopMetric value="3" label="Waiting for Parts" />
        <TopMetric value="5" label="Ready for Pickup" />
      </div>
