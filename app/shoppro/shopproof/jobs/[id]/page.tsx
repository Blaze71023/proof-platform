            ...
            <div style={heroMetaGridStyle}>
              <div style={metaBlockStyle}>
                ...
                <div style={metaValueStyle}>
                  {customer?.name?.trim() || "Walk-in / Unassigned"}
                </div>
              </div>

              <div style={metaBlockStyle}>
                <div style={metaLabelStyle}>Phone</div>
                <div style={metaValueStyle}>{customer?.phone?.trim() || "—"}</div>
              </div>
              ...
              <div style={metaBlockStyle}>
                ...
                <div style={metaValueStyle}>{customer?.address?.trim() || "—"}</div>
              </div>
            </div>
          </section>
              ...
              <div style={flowListStyle}>
                ...
                <div style={flowItemStyle}>
                  ...
                  <div>
                    ...
                    <div style={flowTextStyle}>Findings entered and reviewed.</div>
                  </div>
                </div>
