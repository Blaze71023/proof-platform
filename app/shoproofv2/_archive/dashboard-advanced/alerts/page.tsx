    ...
    >
      ...
      >
        ...
        <div style={{ padding: 18, display: "grid", gap: 14, position: "relative", zIndex: 1 }}>
          <ActionRow />
          <Panel title="Alerts & Issues Feed">
            <EmptyState />
          </Panel>
        </div>
      </div>
    ...
    >
      ...
      <div>
        ...
        <div style={{ fontSize: 13, color: THEME.textMuted, lineHeight: 1.5 }}>
          Warnings, high-priority concerns, and visibility into shop interruptions.
        </div>
      </div>
    ...
    <div style={{ display: "grid", gridTemplateColumns: "1fr auto", gap: 12 }}>
      ...
      >
        ...
        <span style={{ fontSize: 13, color: THEME.textMuted }}>
          Search warnings, notes, vehicles, or service interruptions...
        </span>
      </div>
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 420, display: "grid", justifyItems: "center" }}>
        ...
        >
          <ShieldAlert size={30} strokeWidth={2.1} color={THEME.red} />
        </div>
        ...
        <div style={{ fontSize: 14, color: THEME.textMuted, lineHeight: 1.65, marginBottom: 18 }}>
          High-priority warnings and service issues will show here when the shop needs immediate attention.
        </div>
