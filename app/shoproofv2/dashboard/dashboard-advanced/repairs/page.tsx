    ...
    >
      ...
      <div>
        ...
        <div style={{ fontSize: 13, color: THEME.textMuted, lineHeight: 1.5 }}>
          Live repair work, technician progress, and service workflow visibility.
        </div>
      </div>
    ...
    <div style={{ display: "grid", gridTemplateColumns: "1fr auto", gap: 12 }}>
      ...
      >
        ...
        <span style={{ fontSize: 13, color: THEME.textMuted }}>
          Search active jobs, tech names, or repair stage...
        </span>
      </div>
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 420, display: "grid", justifyItems: "center" }}>
        ...
        >
          <Clock3 size={30} strokeWidth={2.1} color={THEME.blue} />
        </div>
        ...
        <div style={{ fontSize: 14, color: THEME.textMuted, lineHeight: 1.65, marginBottom: 18 }}>
          Repair work in progress will appear here once jobs are created, approved, and moved into service.
        </div>
