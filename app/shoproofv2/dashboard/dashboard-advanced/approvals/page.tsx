    ...
    >
      ...
      >
        ...
        <TopBar
          ...
          subtitle="Pending customer decisions, estimate follow-up, and approval tracking."
          ctaLabel="New Job"
          ctaHref="/shopproof/new"
          icon={<Bell size={22} strokeWidth={2.1} color={THEME.orange} />}
        />
        ...
        <div style={{ padding: 18, display: "grid", gap: 14, position: "relative", zIndex: 1 }}>
          ...
          <Panel title="Approval Queue">
            <EmptyState
              icon={<ClipboardList size={30} strokeWidth={2.1} color={THEME.orange} />}
              title="No jobs waiting for approval"
              text="When estimates are built and sent to customers, those pending authorizations will show up here."
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <div style={{ fontSize: 13, color: THEME.textMuted, lineHeight: 1.5 }}>{subtitle}</div>
      </div>
    ...
    <div style={{ display: "grid", gridTemplateColumns: "1fr auto", gap: 12 }}>
      ...
      >
        ...
        <span style={{ fontSize: 13, color: THEME.textMuted }}>
          Search approvals, customer names, or estimate status...
        </span>
      </div>
